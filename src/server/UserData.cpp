...
UserData::UserData() : _online(Offline), _name(""), _password("")
{
}

UserData::UserData(std::string const& name, std::string const& password) : _online(Offline), _name(name), _password(password)
{
}
UserData::UserData(std::string const& name, std::string const& password,
				   ...
				   _online(Offline), _name(name), _password(password), _friendList(friendList), _friendListRequest(friendListRequest)
{
}
...
eFriendStatus			UserData::getOnlineStatus() const
{
	return this->_online;
}

void					UserData::setOnlineStatus(eFriendStatus friendStatus)
{
	this->_online = friendStatus;
}
